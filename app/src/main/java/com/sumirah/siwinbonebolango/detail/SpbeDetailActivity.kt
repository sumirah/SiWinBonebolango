...
import kotlinx.android.synthetic.main.activity_spbedetail.*


class SpbeDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this).load(R.drawable.logo).into(logo_detail)

        val spbe = intent.getParcelableExtra<Spbe>("MATCH_OBJECT")
        txt_nama_aplikasi.text = spbe.namaAplikasi
        txt_nama_instansi.text = spbe.namaInstansi
        txt_jenis_kategori.text = spbe.jenisKategori
        txt_deskripsi_aplikasi.text = spbe.deskripsiAplikasi
        txt_link_aplikasi.text = spbe.linkAplikasi


        val url = txt_link_aplikasi
